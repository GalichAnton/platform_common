...
//go:generate minimock -i github.com/GalichAnton/platform_common/pkg/db.NamedExecer -o named_execer_minimock.go -n NamedExecerMock -p mocks
...
import (
	...
	mm_db "github.com/GalichAnton/platform_common/pkg/db"
